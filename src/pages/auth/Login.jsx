...
export const Login = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-cream-100 to-cream-50">
      <div className="max-w-md w-full space-y-8 bg-white p-8 md:p-10 rounded-3xl border border-rose-200 shadow-xl relative">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-serif font-bold text-dark-800 pt-2">Welcome Back</h2>
          <p className="text-xs text-muted-500">Access your verified matrimonial dashboard</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-cream-50 border border-rose-200 text-dark-800 text-xs rounded-xl pl-10 pr-4 py-3 focus:ring-2 focus:ring-maroon-600 focus:outline-none font-medium"
              />
            </div>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <Link to="/forgot-password" className="text-xs font-semibold text-maroon-600 hover:text-maroon-800">
                Forgot Password?
              </Link>
            </div>
            <div className="relative">
              <Lock className="w-4 h-4 text-muted-400 absolute left-3.5 top-3.5" />
              <input
                type="password"
                required
                value={password}
          ...
          <div className="flex items-center justify-between text-xs">
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-dark-800 font-medium">Keep me logged in</span>
            </label>
          </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs uppercase"><span className="bg-white px-3 text-muted-400 font-semibold">Or</span></div>
        </div>

        {/* Social / Mock Google login */}
        <button
          onClick={handleSubmit}
          type="button"
          className="w-full py-2.5 px-4 border border-gray-300 rounded-xl text-xs font-semibold text-dark-800 bg-white hover:bg-gray-50 flex items-center justify-center gap-2 transition-all shadow-xs"
        >
        ...
        {/* Footer */}
        <p className="text-center text-xs text-muted-500 pt-2">
          New to AdarshVivah?{' '}
